...
- (void)setupBackgroundLayerWithFillColor:(UIColor *)fillColor {
    ...
    //TODO: Change the light grey color later.
    self.backgroundLayer.strokeColor =  [UIColor colorWithRed:0.6f green:0.6f blue:0.6f alpha:1].CGColor;   //[UIColor lightGrayColor].CGColor;
...
- (void)setupPercentLabel {
    ...
    NSLayoutConstraint *centerVer = [NSLayoutConstraint constraintWithItem:self attribute:NSLayoutAttributeCenterY relatedBy:NSLayoutRelationEqual toItem:self.percentLabel attribute:NSLayoutAttributeCenterY multiplier:0.9 constant:0];
